 ...
 * @author Hp
 */
public class ManageNotice extends javax.swing.JFrame {

    /**
     * Creates new form ManageNotice
     */
    public ManageNotice() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Notice ID", "Topic", "Department", "Date", "Notice"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManageNotice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManageNotice().setVisible(true);
            }
        });
    }
