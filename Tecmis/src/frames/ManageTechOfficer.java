 ...
 * @author Hp
 */
public class ManageTechOfficer extends javax.swing.JFrame {


    public ManageTechOfficer() throws SQLException, ClassNotFoundException{
        initComponents();
        showuser();
    ...
    public void showuser() throws SQLException, ClassNotFoundException{
        techofficerdata td = new techofficerdata();
         ArrayList<User> list = td.userList();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Manage tech officers");
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        try {
            ...
            Logger.getLogger(ManageTechOfficer.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManageTechOfficer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ManageTechOfficer().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(ManageTechOfficer.class.getName()).log(Level.SEVERE, null, ex);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(ManageTechOfficer.class.getName()).log(Level.SEVERE, null, ex);
