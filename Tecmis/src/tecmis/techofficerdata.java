...
public class techofficerdata {
        ...
        ArrayList<User> userList = new ArrayList<>();
            ...
            String query1 = "SELECT user_id,f_name,l_name,email,dob,mobile_no FROM user where user_id IN(SELECT user_id FROM user_login_data WHERE role='to')";
